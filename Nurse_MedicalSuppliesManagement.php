    ...
    <div class="logo-area">
       ...
       <nav class="nav-menu">
        <ul>
            ...
            <li><a class="active" href="Nurse_MedicalSuppliesManagement.php" aria-current="page"><i class="bi bi-calendar-check"></i><span>Medical Supplies Management</span></a></li>
